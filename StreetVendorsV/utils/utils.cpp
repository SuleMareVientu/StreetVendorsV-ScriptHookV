...
void DisablePlayerActionsThisFrame()
{
	...
	SET_PED_RESET_FLAG(playerPed, PRF_DisablePlayerJumping, true);
	SET_PED_RESET_FLAG(playerPed, PRF_DisablePlayerVaulting, true);
	SET_PED_MAX_MOVE_BLEND_RATIO(playerPed, PEDMOVEBLENDRATIO_WALK);	//Prevents the player from running/sprinting
	return;
}
